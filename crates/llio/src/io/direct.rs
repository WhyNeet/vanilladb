...
impl DirectFileIo {
    ...
    pub fn flush_page(&mut self, idx: u64, page: crate::page::Page) -> std::io::Result<()> {
    ...
    pub fn load_page(&self, idx: u64) -> io::Result<Page> {
